...
/*
    ...
    - GetKeyboardLayout (international layouts, etc)
...
internal void 
CatStrings( uint32 SourceACount, char* SourceA,
            uint32 SourceBCount, char* SourceB,
...
Win32LoadGameCode(const char* SourceDLLName, const char* TempDLLName)
{
    ...
    Result.GameCodeDLL = LoadLibraryA("baroque_temp.dll");
        ...
        int ShowCode)
{
    ...
    Win32BuildEXEPathFileName(&Win32State, "baroque.dll", WIN32_STATE_FILE_NAME_COUNT, SourceGameCodeDLLFullPath);
    Win32BuildEXEPathFileName(&Win32State, "baroque_temp.dll", WIN32_STATE_FILE_NAME_COUNT, TempGameCodeDLLFullPath);
...
//    WindowClass.hIcon;
    WindowClass.lpszClassName = "BaroqueWindowClass";
                ...
                while(GlobalRunning)
                {
                    ...
                    *NewKeyboardController = ZeroController;
                    ...
                    if (!GlobalPause)
                    {
                        ...
                        {
                            Game.UpdateAndRender(&GameMemory, NewInput, &GameBuffer, &Thread);
                        }
