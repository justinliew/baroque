#ifndef __BAROQUE_PLATFORM_H_

#ifdef __cplusplus
extern "C" {
#endif

// TODO - BAROQUE_INTERNAL: 0 means build for public release. 1 means dev only. 
...
#define GAME_UPDATE_AND_RENDER(name) void name(game_memory* Memory, game_input* Input, game_offscreen_buffer* Buffer, thread_context* Thread)
...
#define __BAROQUE_PLATFORM_H_
#endif __BAROQUE_PLATFORM_H_